#!/bin/bash
#SBATCH -J tr_s2ip_k3_msep_sp_2263
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:1
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_train_pool0709_sentence_s2ip_k3_marginsep_sepproj_diag_ep3_002263XSHE.out
