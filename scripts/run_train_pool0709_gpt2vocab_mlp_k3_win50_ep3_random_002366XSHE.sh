#!/bin/bash
#SBATCH -J tr_g2v_r_2366
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:1
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_train_pool0709_gpt2vocab_mlp_k3_win50_ep3_random_002366XSHE_%j.out
