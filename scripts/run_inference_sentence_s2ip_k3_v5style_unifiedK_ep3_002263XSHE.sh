#!/bin/bash
#SBATCH -J ie_k3v5u_263
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:1
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_inference_sentence_s2ip_k3_v5style_unifiedK_ep3_002263XSHE_%j.out
...
CKPT="$ROOT/training_runs/pool_0709_0710_train0709_sentence_preset_s2ip_win50_k3_v5style_unifiedK_3ep/${TAG}/model_cache/preGPT2sentS2IP_20250709_txncomplete_${TAG}_win50_k3_v5style_unifiedK_20260411_222205_best.pt"
