#!/bin/bash
#SBATCH -J tr_sentk3_w100_617_d1
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:1
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_train_pool0709_sentence_k3_win100_ep3_phase1diag_000617XSHE_%j.out
...
python -u scripts/train_blankgpt2_sentence_preset_anchor_s2ip_txncomplete_single_day.py \
  ...
  --router-diag-jsonl "$ROOT/training_runs/pool_0709_0710_train0709_sentence_k3_baseline_win100_ep3_phase1diag/000617XSHE/router_diag.jsonl" \
