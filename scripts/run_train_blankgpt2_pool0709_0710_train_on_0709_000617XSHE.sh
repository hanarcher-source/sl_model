...
#SBATCH --gres=gpu:1
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_train_blankgpt2_pool0709_0710_train0709_000617XSHE.out
#SBATCH --reservation=finai

# Pooled-bin preprocess; train on 20250709 joblib only, 3 epochs, vocab 40560.
...
python -u scripts/train_blankgpt2_openbidanchor_txncomplete_single_day.py \
  ...
  --output-root "$ROOT/training_runs/pool_0709_0710_train0709_blank_gpt2" \
  --epochs 3 \
  --vocab-size 40560
