#!/bin/bash
#SBATCH -J tr_bsphP_2721
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:1
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_train_bookstate_parallelheads_anchor5m_pretrained_002721XSHE_%j.out
...
python -u scripts/train_bookstate_parallelheads_anchor5m.py \
  ...
  --output-root "$ROOT/training_runs/pool_0709_bookstate_parallelheads_anchor5m_pretrained"
