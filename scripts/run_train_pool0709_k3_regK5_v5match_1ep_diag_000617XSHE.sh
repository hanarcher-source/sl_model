#!/bin/bash
#SBATCH -J tr_k3rK5v5_617
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:1
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_train_pool0709_k3_regK5_v5match_1ep_diag_000617XSHE.out
#SBATCH --reservation=finai

# Routing K=3, V5-style align+sep at K_reg=5, V5-like defaults (1 epoch diagnostic).
...
OUT_ROOT="$ROOT/training_runs/pool_0709_0710_train0709_sentence_preset_s2ip_win50_k3_regK5_v5match_1ep_diag"
