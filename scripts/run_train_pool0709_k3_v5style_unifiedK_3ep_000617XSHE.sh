#!/bin/bash
#SBATCH -J tr_k3v5uni3_617
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:1
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_train_pool0709_k3_v5style_unifiedK_3ep_000617XSHE.out
#SBATCH --reservation=finai

# K=3 prefix; V5-style align (mean top K+1) + sep (s_K - s_{K+1}) with SAME K=3 — max 3 epochs (same trainer/flags as 1ep diag).
...
OUT_ROOT="$ROOT/training_runs/pool_0709_0710_train0709_sentence_preset_s2ip_win50_k3_v5style_unifiedK_3ep"
