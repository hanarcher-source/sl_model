...
CKPT=$(ls -t $ROOT/training_runs/pool_0709_0710_train0709_blank_gpt2_dynamic_anchor_variants_win50/${TAG}/dyn_gatebias/model_cache/*_best.pt 2>/dev/null | head -n 1 || true)
...
OUT=$ROOT/saved_LOB_stream/pool_0709_0710_eval_0710_model_variants/dyn_gatebias/${SWEEP_TAG}
mkdir -p "$OUT"
