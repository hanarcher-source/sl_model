#!/bin/bash
#SBATCH -J slm_eval_real_stream
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:0
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_eval_realflow_stream.out
...
python -u scripts/eval_realflow_stream.py
