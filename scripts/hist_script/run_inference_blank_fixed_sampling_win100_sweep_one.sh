...
CKPT=$(ls -t $ROOT/training_runs/pool_0709_0710_train0709_blank_gpt2_win100/${TAG}/model_cache/*_best.pt 2>/dev/null | head -n 1 || true)
...
OUT=$ROOT/saved_LOB_stream/pool_0709_0710_eval_0710_model_variants/blank_fixed_sampling_win100/${SWEEP_TAG}
mkdir -p "$OUT"
