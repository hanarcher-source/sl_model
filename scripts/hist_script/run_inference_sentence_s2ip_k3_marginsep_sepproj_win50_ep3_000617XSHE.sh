#!/bin/bash
#SBATCH -J ie_msep_sp_k3_617
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:1
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_inference_sentence_s2ip_k3_marginsep_sepproj_win50_ep3_000617XSHE_%j.out
