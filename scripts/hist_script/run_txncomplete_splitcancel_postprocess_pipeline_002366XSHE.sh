#!/bin/bash
#SBATCH -J pipe_tcsc_2366
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=64
#SBATCH --gres=gpu:0
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_txncomplete_splitcancel_postprocess_pipeline_002366XSHE.out
...
python -u scripts/hist_script/run_txncomplete_splitcancel_postprocess_pipeline.py \
  --stock 002366_XSHE \
  --day 20250710 \
  --pipeline-out-dir "/finance_ML/zhanghaohan/stock_language_model/saved_LOB_stream/pipeline_txncomplete_splitcancel_002366XSHE_${PIPELINE_TS}"
