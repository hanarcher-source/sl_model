...
def _evaluate(exp_dir: str, real_ref_dir: str):
    ...
    logger.info("=" * 70)
    logger.info("decoded real-token open-anchor evaluation")
    logger.info("=" * 70)
...
def main():
    parser = argparse.ArgumentParser(description="Replay real token stream through fixed open-bid-anchor decoding and evaluate it.")
    ...
    exp_name = f"fixed_start_decoded_real_tokens_openbidanchor_{stock_tag}"
