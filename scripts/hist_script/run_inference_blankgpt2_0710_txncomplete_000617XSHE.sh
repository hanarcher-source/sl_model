#!/bin/bash
#SBATCH -J inf709b_617
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:1
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_inference_blankgpt2_0710_txncomplete_000617XSHE.out
#SBATCH --reservation=finai

# 20250710 preprocess (5-side txn-complete) + clean ref + direct-replay metrics from 20260404/05 runs.
