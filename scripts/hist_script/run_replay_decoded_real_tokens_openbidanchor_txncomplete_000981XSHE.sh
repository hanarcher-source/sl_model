...
#SBATCH -J reotc_000981
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=64
#SBATCH --gres=gpu:0
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_replay_decoded_real_tokens_openbidanchor_txncomplete_000981XSHE.out
...
python -u scripts/hist_script/replay_decoded_real_tokens_openbidanchor_txncomplete_fixed_start.py \
  ...
  --bin-record-path /finance_ML/zhanghaohan/stock_language_model/saved_LOB_stream/processed_real_flow/bin_record_realflow_openbidanchor_txncomplete_20250710_000981XSHE_20260404_2207.json \
