...
TRAIN_ROOT=$ROOT/training_runs/pool_0709_0710_train0709_sentence_k3_baseline_win100_ep3
...
OUT=$ROOT/saved_LOB_stream/pool_0709_0710_eval_0710_model_variants/sentence_k3_win100/${SWEEP_TAG}
mkdir -p "$OUT"
