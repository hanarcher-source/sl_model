#!/bin/bash
#SBATCH -J ie_s2ip_k1_617
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:1
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_inference_sentence_s2ip_k1_win50_ep3_000617XSHE_%j.out
...
CKPT=$ROOT/training_runs/pool_0709_0710_train0709_sentence_preset_s2ip_win50_k1/${TAG}/model_cache/preGPT2sentS2IP_20250709_txncomplete_${TAG}_win50_k1_20260410_203046_best.pt
