#!/bin/bash
#SBATCH -J preo709_981
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=64
#SBATCH --gres=gpu:0
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_preprocess_real_lob_20250709_openbidanchor_txncomplete_000981XSHE.out
...
python -u scripts/hist_script/preprocess_real_lob_20250710_openbidanchor_txncomplete.py \
  --stock 000981_XSHE --day 20250709 \
