#!/bin/bash
#SBATCH -J rgrotsc_981
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=64
#SBATCH --gres=gpu:0
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_generate_lobster_stream_real_openbidanchor_txncomplete_splitcancel_000981XSHE.out
