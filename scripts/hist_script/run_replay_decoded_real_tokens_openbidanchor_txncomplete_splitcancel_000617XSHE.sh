#!/bin/bash
#SBATCH -J reotcsc_617
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=64
#SBATCH --gres=gpu:0
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_replay_decoded_real_tokens_openbidanchor_txncomplete_splitcancel_000617XSHE.out
