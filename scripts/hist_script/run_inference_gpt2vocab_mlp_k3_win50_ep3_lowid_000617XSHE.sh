#!/bin/bash
#SBATCH -J ie_g2v_l_617
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:1
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_inference_gpt2vocab_mlp_k3_win50_ep3_lowid_000617XSHE_%j.out
...
CKPT=$ROOT/training_runs/pool_0709_0710_train0709_gpt2vocab_mlp_k3_win50_ep3_lowid/${TAG}/model_cache/preGPT2sentS2IP_20250709_txncomplete_${TAG}_win50_k3_20260410_161513_best.pt
