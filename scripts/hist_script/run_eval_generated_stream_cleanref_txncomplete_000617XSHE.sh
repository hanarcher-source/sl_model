...
#SBATCH --gres=gpu:0
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/eval_against_clean_refs/000617XSHE_txncomplete_vs_cleanref.log
...
python -u scripts/hist_script/eval_generated_stream.py \
  /finance_ML/zhanghaohan/stock_language_model/saved_LOB_stream/fixed_start_decoded_real_tokens_openbidanchor_txncomplete_000617XSHE_20260404_222446 \
