#!/bin/bash
#SBATCH -J ie_pre_T10_2366
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:1
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_inference_pretrained_T10_k0_win50_002366XSHE_%j.out
...
OUT=$ROOT/saved_LOB_stream/pool_0709_0710_eval_0710_model_variants/pretrained_T10_k0_win50
mkdir -p "$OUT"
