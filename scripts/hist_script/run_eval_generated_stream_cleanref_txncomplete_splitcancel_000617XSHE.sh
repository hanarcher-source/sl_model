#!/bin/bash
#SBATCH -J egctxsc_617
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:0
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/eval_against_clean_refs/000617XSHE_txncomplete_splitcancel_vs_cleanref.log
