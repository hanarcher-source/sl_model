...
# Pooled-bin 0709+0710 preprocessing outputs (per-stock) for eval day 0710
...
# Clean real reference stream (same as previous pooled-bin experiment)
...
# Training checkpoint (trained on 0709 slice under pooled-bin regime)
CKPT=$(ls -t $ROOT/training_runs/pool_0709_0710_train0709_blank_gpt2/${TAG}/model_cache/*_best.pt 2>/dev/null | head -n 1 || true)
...
OUT=$ROOT/saved_LOB_stream/pool_0709_0710_eval_0710_sweep/${SWEEP_TAG}
mkdir -p "$OUT"
