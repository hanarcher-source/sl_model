#!/bin/bash
#SBATCH -J tr_s2ip_tA1_617
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:1
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_train_pool0709_sentence_s2ip_trackA_clustered_ep3_topk1_routerdiag_000617XSHE_%j.out
#SBATCH --reservation=finai

# Track A clustered captions; same as clustered ep3 run except prepend K=1 (single anchor token).
# Router diagnostics: entropy / Neff / HHI / top-1 share / top-k usage -> anchor collapse & diversity.
...
OUT_ROOT="$ROOT/training_runs/pool_0709_0710_train0709_sentence_preset_s2ip_win50_trackA_clustered_topk1_routerdiag"
