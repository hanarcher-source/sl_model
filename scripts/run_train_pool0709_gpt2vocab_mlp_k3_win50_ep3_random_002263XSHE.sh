#!/bin/bash
#SBATCH -J tr_g2v_r_2263
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:1
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_train_pool0709_gpt2vocab_mlp_k3_win50_ep3_random_002263XSHE_%j.out
...
python -u scripts/train_blankgpt2_sentence_preset_anchor_s2ip_txncomplete_single_day.py \
  ...
  --output-root "$ROOT/training_runs/pool_0709_0710_train0709_gpt2vocab_mlp_k3_win50_ep3_random" \
  --epochs 3 \
  --patience 3 \
  --window-len 50 \
  --batch-size 256 \
