#!/bin/bash
#SBATCH -J tr_k3v5uni3_721
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:1
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_train_pool0709_k3_v5style_unifiedK_3ep_002721XSHE.out
#SBATCH --reservation=finai

# K=3 prefix; V5-style align + sep unified K — max 3 epochs (same trainer/flags as 1ep diag).
