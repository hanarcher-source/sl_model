#!/bin/bash
#SBATCH -J tr_k3v5uni_617
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:1
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_train_pool0709_k3_v5style_unifiedK_1ep_diag_000617XSHE.out
#SBATCH --reservation=finai

# K=3 prefix; V5-style align (mean top K+1) + sep (s_K - s_{K+1}) with SAME K=3 (not rank-5/6).
