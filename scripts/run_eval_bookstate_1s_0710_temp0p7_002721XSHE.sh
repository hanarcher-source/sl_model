#!/bin/bash
#SBATCH -J ie_bsph_2721_t07
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:1
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_eval_bookstate_1s_0710_temp0p7_002721XSHE_%j.out
...
OUT="$ROOT/saved_LOB_stream/pool_0710_bookstate_eval_1s/bsph_temp_singles_T300_ctx60_start1000"
mkdir -p "$OUT"
