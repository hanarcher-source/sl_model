#!/bin/bash
#SBATCH -J trw100_2366
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:1
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_train_blankgpt2_pool0709_0710_train0709_win100_002366XSHE.out
#SBATCH --reservation=finai

# Pooled-bin preprocess; train on 20250709 joblib only, blank GPT2 backbone, window_len=100.
...
python -u scripts/train_blankgpt2_openbidanchor_txncomplete_single_day.py \
  ...
  --output-root "$ROOT/training_runs/pool_0709_0710_train0709_blank_gpt2_win100" \
  --epochs 3 \
  --vocab-size 40560 \
  --window-len 100
