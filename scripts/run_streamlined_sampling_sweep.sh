...
#SBATCH -J slm_streamlined_sweep
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=64
#SBATCH --gres=gpu:1
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_streamlined_sampling_sweep.out
...
python -u scripts/run_streamlined_sampling_sweep.py "$CKPT_PATH" \
