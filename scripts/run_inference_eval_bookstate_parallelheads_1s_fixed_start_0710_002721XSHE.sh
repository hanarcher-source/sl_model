#!/bin/bash
#SBATCH -J ie_bsph_2721_710
#SBATCH -p batch
#SBATCH -N 1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:1
#SBATCH -o /finance_ML/zhanghaohan/stock_language_model/logs/run_inference_eval_bookstate_parallelheads_1s_fixed_start_0710_002721XSHE_%j.out
